...
void trocarSenha(){
    lcd_clear();
    lcd_puts("Modo mudar senha:");
    lcd_goto(40);
    lcd_puts("Digite sua nova senha:");
    while(flag !=1){
        PORTBbits.RB5 =1;
        ...
        if(RCREG == 'c'){
            ...
            if(RCREG == 'd') {
                flag =1;
                lcd_clear();
                lcd_puts("Senha não alterada");
                _delay((unsigned long)((1000)*(4000000/4000.0)));
                lcd_clear();
                lcd_puts("Digite sua senha:");
            }
        }
    }
    flag =0;
...
void senhaAlterada(){
    lcd_clear();
    lcd_puts("Senha alterada com sucesso:");
...
void alarme() {
    ...
    lcd_puts("    ALARME");
    lcd_goto(40);
    lcd_puts("Digite a senha padrao:");
}
